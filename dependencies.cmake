...
if (NOT EXISTS ${psi_thread_dir})
    set (psi_thread_dir "")
    find_submodule(psi-thread psi_thread_dir)
    message("psi_thread_dir: ${psi_thread_dir}")
    if (NOT EXISTS ${psi_thread_dir})
        add_subdirectory(3rdparty/psi-thread)
    endif()
endif()
...
if (NOT EXISTS ${psi_shared_dir})
    set (psi_shared_dir "")
    find_submodule(psi-shared psi_shared_dir)
    message("psi_shared_dir: ${psi_shared_dir}")
    if (NOT EXISTS ${psi_shared_dir})
        add_subdirectory(3rdparty/psi-shared)
    endif()
endif()
